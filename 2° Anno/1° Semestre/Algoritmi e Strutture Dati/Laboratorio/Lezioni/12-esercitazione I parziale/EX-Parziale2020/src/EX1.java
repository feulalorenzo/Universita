...
List<Termine> list = new LinkedList<Termine>( );
   ...
   * una variabile (oggetto di tipo ArrayList<Espressione>), ordina la lista rispetto al
   * grado dell'espressione (il grado dell'espressione rispetto alla variabile x è l'esponente
   * più alto con cui x compare in essa).
