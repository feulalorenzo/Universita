...
public class GenericSortTimes
{
	...
	int L = 10000, MAXINT = 1000, NUMSIM = 50; // pochi duplicati  
	...
	double time_qIt1=0;
	double time_qIt=0;
	double time_Ah=0, time_ALh=0, time_h=0;
	double time_sort=0;
...
//HEAP-SORT
	...
	//ARRAY-HEAPSORT
	    ...
	    numbersCopy=numbers.clone();
	  	startTime = System.currentTimeMillis(); //The currentTimeMillis() method returns the current time in milliseconds.
	  		GenericSort.heapSortA(numbersCopy);
	  	endTime = System.currentTimeMillis();
	    ...
	    numbersCopy=numbers.clone();
	  	startTime = System.currentTimeMillis(); //The currentTimeMillis() method returns the current time in milliseconds.
	  		GenericSort.heapSortAL(numbersCopy);
	  	endTime = System.currentTimeMillis();
	    ...
	    numbersCopy=numbers.clone();
	  	startTime = System.currentTimeMillis(); //The currentTimeMillis() method returns the current time in milliseconds.
	  		GenericSort.heapSort(numbersCopy);
	  	endTime = System.currentTimeMillis();
