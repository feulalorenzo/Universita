...
/* ESERCITAZIONE: 
 * Test sull'uso di SortedDoublyLinkedList
 * 
 */
...
public class Test2 {
	  ...
	  public static void main (String[ ] args) {
		  ...
		  public void run(){
			 SortedDoublyLinkedList<String> listOfString = new SortedDoublyLinkedList<String>();
		     ...
		     System.out.println ("\nlistOfString:\n" + listOfString);  
		     // Print out twinList   
		     SortedDoublyLinkedList<String> twinList = listOfString.copy2();
		     System.out.println ("\ntwinList:\n" + twinList);
